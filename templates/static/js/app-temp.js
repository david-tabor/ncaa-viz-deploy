...
function init() {
  ...
  dropdown_ids = ['#selConference']

  dropdown_ids.forEach((dropdown_id) => {
    console.log(`entering loop with dropdown_id = ${dropdown_id}`)

    var selector = d3.select(dropdown_id);
...
console.log('approaching init() call.')
init();
